...
// Swift Package Manager manifest for the flutter_eap macOS plugin.
...
let package = Package(
    ...
    dependencies: [],
    targets: [
        // Swift plugin class (FlutterEapPlugin). The C bridge is a separate
        ...
        // The public header (include/flutter_eap_macos.h) exposes only the
        // functions FlutterEapPlugin.swift needs. skylelib's namespaced
