 ...
 * CocoaPods vendors it via flutter_skyle.podspec (per-SDK header search paths for
 ...
 * ExternalAccessory (see FlutterSkylePlugin.swift / OutputStreamManager.swift).
 */

#include "../../../../darwin/Classes/flutter_skyle_bridge_apple.c"
#include "../../../../native/link/flutter_skyle_link_glue.c"
