...
class RotatedRect {
  ...
  factory RotatedRect.fromSkyleRotatedRect(SkyleRotatedRect rect) {
    return RotatedRect(center: Point2d.fromSkylePointf(rect.center), size: Size2d.fromSkyleSizef(rect.size), angle: rect.angle.toDouble());
  }
