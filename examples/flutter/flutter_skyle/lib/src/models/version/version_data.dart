...
class VersionData {
  ...
  /// Protocol version string (e.g. "1.0.0"). Empty string means firmware predates versioning.
  ...
  factory VersionData.fromSkyleVersionResponse(SkyleVersionResponse version) {
