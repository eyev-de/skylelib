...
class IrisData {
  ...
  factory IrisData.fromSkyleIris(SkyleComplexIris iris) {
    return IrisData(
      center: Point2d.fromSkylePointf(iris.center),
      top: Point2d.fromSkylePointf(iris.top),
      left: Point2d.fromSkylePointf(iris.left),
      right: Point2d.fromSkylePointf(iris.right),
      bottom: Point2d.fromSkylePointf(iris.bottom),
