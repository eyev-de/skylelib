...
class GazesData {
  ...
  factory GazesData.fromSkyleGazeResponse(SkyleGazeResponse response) {
    return GazesData(
      timestamp: response.header.timestampMs,
      leftEye: GazeData.fromSkyleComplexGaze(response.left),
      rightEye: GazeData.fromSkyleComplexGaze(response.right),
      combined: GazeData.fromSkyleComplexGaze(response.both),
    );
  }
