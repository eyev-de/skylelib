...
class GazeData {
  ...
  factory GazeData.fromSkyleComplexGaze(SkyleComplexGaze gaze) {
    return GazeData(raw: Point2d.fromSkylePointf(gaze.raw), smoothed: Point2d.fromSkylePointf(gaze.smoothed), type: GazeType.fromValue(gaze.type));
  }
