...
handling with an FFI bridge to Dart. macOS uses IOKit for USB bulk transfers.
  ...
  # - flutter_skyle/Sources/flutter_skyle_bridge/include/flutter_skyle_macos.h
  ...
  s.public_header_files = 'flutter_skyle/Sources/flutter_skyle_bridge/include/flutter_skyle_macos.h'
  ...
  # The xcframework is then copied into macos/flutter_skyle/.skylelib/ - INSIDE
  ...
  slice = '${PODS_TARGET_SRCROOT}/flutter_skyle/.skylelib/skylelib.xcframework/macos-arm64_x86_64'
