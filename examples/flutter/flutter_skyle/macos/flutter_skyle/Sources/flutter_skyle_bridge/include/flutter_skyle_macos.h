/**
 * Umbrella header for flutter_skyle macOS module.
 *
...
#ifndef FLUTTER_SKYLE_MACOS_H
#define FLUTTER_SKYLE_MACOS_H
...
int flutter_skyle_configure_iokit_transport(skyle_client* client, uint16_t vendor_id, uint16_t product_id);
